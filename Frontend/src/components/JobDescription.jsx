...
<h1 className='font-bold my-1'>Description:<span className='pl-4 font-normal text-gray-800'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure, qui.</span></h1>
...
<h1 className='font-bold my-1'>Posted Data:<span className='pl-4 font-normal text-gray-800'>17-07-2025</span></h1>
    </div>
    </div> 
  )
}
